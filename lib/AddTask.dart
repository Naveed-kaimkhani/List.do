  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child:SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "Add Task",style: HeadingStyle,
              ),
              InputField(title: "Title", hint: "Enter task title",controller: titleController,),
              InputField(title: "Note", hint: "Enter your note",controller: noteController,),
            ...
            Row(
              children: [
                ...
                widget:IconButton(icon: Icon(Icons.access_time_filled_rounded,color: Colors.grey,),
                onPressed: (){
            ...
            InputField(title: "Remind", hint: "$remindme five minutes early",
            ...
            InputField(title: "Repeat", hint: Repeat,
            widget: DropdownButton(
              icon: Icon(Icons.keyboard_arrow_down,color: Colors.grey,),
              iconSize: 32,
              elevation: 4,
                       ...
                       (int index){
                         return Padding(
                           ...
                           child: GestureDetector(
                             ...
                             child: CircleAvatar(
                               child: index==selectedindex?Icon(Icons.done,color: Colors.white,):Container(),
                               radius:14,
                               backgroundColor:index==0?Color(0xFF4e5ae8):index==1?Colors.pink:Colors.yellow,
      ...
      child: Container(
        width: 120,
        height: 40,
        child: Center(child: Text("Create Task",style: TextStyle(color: Colors.white,),)),
...
_validateData(){
  if(titleController.text.isNotEmpty&&noteController.text.isNotEmpty){
    ...
    icon: Icon(Icons.warning_amber_rounded,color: Colors.pink,),
    );
